...
my $class = 'Koha::Plugin::Com::ByWaterSolutions::EdifactLibraria::Edifact::Segment';
...
subtest 'de_escape removes EDIFACT release character' => sub {
    ...
    my $de_escape = \&Koha::Plugin::Com::ByWaterSolutions::EdifactLibraria::Edifact::Segment::de_escape;
